...
@section('main-content')
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <div
            ...
            <div>
                <a href="{{ route('team.create') }}" class="btn btn-success btn-sm p-2">ایجاد تیم</a>
            </div>
            <div>
                ...
                <tbody>
                    @foreach ($teams as $key => $team)
                        <tr>
                            ...
                            <td class="text-center img-fluid"><img src="{{asset('images/team/'.$team->image)}}" style="width: 45px; height: 45px;" alt="{{$team->alt}}"></td>
                            <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                                ...
                                <form action="{{ route('team.destroy', $team->id) }}" class="mb-2" method="POST">
                                    @method('DELETE')
                                    @csrf
