                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="fullName" name="fullName"
                            placeholder="نام و نام خانوادگی را وارد کنید" value="{{ old('fullName',$team->fullName) }}">
                        @error('fullName')
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="job" name="job"
                            placeholder="رتبه سازمانی را وارد کنید" value="{{ old('job' , $team->job) }}">
                        @error('job')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="alt" name="alt"
                            placeholder="آلت تصویر را وارد کنید" value="{{ old('alt', $team->alt) }}">
                        @error('alt')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_instagram" name="url_instagram"
                            placeholder="لینک اینستاگرام را وارد کنید" value="{{ old('url_instagram', $team->url_instagram) }}">
                        @error('url_instagram')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_facebook" name="url_facebook"
                            placeholder="لینک فیسبوک را وارد کنید" value="{{ old('url_facebook', $team->url_facebook) }}">
                        @error('url_facebook')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_tiwtter" name="url_twitter"
                            placeholder="لینک توییتر را وارد کنید" value="{{ old('url_tiwtter', $team->url_twitter) }}">
                        @error('url_tiwtter')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_linkden" name="url_linkden"
                            placeholder="لینک لینکدین را وارد کنید" value="{{ old('url_linkden', $team->url_linkden) }}">
                        @error('url_linkden')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
