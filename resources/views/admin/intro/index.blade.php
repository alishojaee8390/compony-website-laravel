        ...
        <section class="table-responsive mt-5">
            <table class="admin-table table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <th scope="row" class="text-center">{{$intro->id}}</th>
                        <td class="text-center">{{$intro->title}}</td>
                        <td class="text-center">{{Str::limit($intro->description , 30)}}</td>
                        <td class="text-center img-fluid"><img src="{{asset('images/intro/'.$intro->image)}}" style="width: 45px; height: 45px;" alt="background_intro"></td>
                        <td class="text-center">{{$intro->link}}</td>
                    
                 
                        <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                            <div class="mb-2">
                                <a href="{{route('intro.edit' , $intro->id)}}" class="btn btn-warning text-white p-2">
