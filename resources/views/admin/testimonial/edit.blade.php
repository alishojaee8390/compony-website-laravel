                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="fullName" name="fullName"
                            placeholder="نام مشتری را وارد کنید" value="{{ old('fullName' , $testimonial->fullName) }}">
                        @error('fullName')
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="job" name="job"
                            placeholder="شغل  را وارد کنید" value="{{ old('job', $testimonial->job) }}">
                        @error('job')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="description" name="description"
                            placeholder="نظر مشتری  را وارد کنید" value="{{ old('description', $testimonial->description) }}">
                        @error('description')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-12 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="alt" name="alt"
                            placeholder="آلت عکس  را وارد کنید" value="{{ old('alt', $testimonial->alt) }}">
                        @error('alt')
                            <span class="text-danger mt-3">{{ $message }}</span>
                        @enderror
                    </div>
