...
<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <h5 class="text-white">بخش تیم</h5>
        ...
        <div
            ...
            <div>
                <a href="<?php echo e(route('team.create')); ?>" class="btn btn-success btn-sm p-2">ایجاد تیم</a>
            </div>
            <div>
            ...
            <table class="admin-table table table-hover">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">رتبه سازمانی</th>
                ...
                <tbody>
                    <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($team->fullName); ?></td>
                            <td class="text-center"><?php echo e($team->job); ?></td>
                            <td class="text-center img-fluid"><img src="<?php echo e(asset('images/team/'.$team->image)); ?>" style="width: 45px; height: 45px;" alt="<?php echo e($team->alt); ?>"></td>
                            <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                                <div class="mb-2">
                                    <a href="<?php echo e(route('team.edit', $team->id)); ?>"
                                        class="btn btn-warning text-white p-2">
                                        <i class="fa fa-edit ms-2"></i>
                                        ویرایش
                                    </a>
                                </div>
                                <form action="<?php echo e(route('team.destroy', $team->id)); ?>" class="mb-2" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/team/index.blade.php ENDPATH**/ ?>