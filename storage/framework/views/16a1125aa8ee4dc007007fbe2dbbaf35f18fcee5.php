            ...
            <table class="admin-table table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center"><?php echo e($contact->fullname); ?></td>
                        <td class="text-center"><?php echo e($contact->subject); ?></td>
                        <td class="text-center"><?php echo e($contact->email); ?></td>
                        <td class="text-center"><?php echo e(Str::limit($contact->description , 25)); ?></td>
                    
          
                        <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                            <form action="<?php echo e(route('contact.destroy', $contact->id)); ?>" class="mb-2" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/contact/index.blade.php ENDPATH**/ ?>