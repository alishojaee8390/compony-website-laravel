...
<?php $__env->startSection('title'); ?>
    <title>ویرایش بخش نظرات مشتریان</title>
<?php $__env->stopSection(); ?>


<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        <h5 class="text-white">ویرایش بخش نظرات مشتریان</h5>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="fullName" name="fullName"
                            placeholder="نام مشتری را وارد کنید" value="<?php echo e(old('fullName' , $testimonial->fullName)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="job" name="job"
                            placeholder="شغل  را وارد کنید" value="<?php echo e(old('job', $testimonial->job)); ?>">
                        <?php $__errorArgs = ['job'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="description" name="description"
                            placeholder="نظر مشتری  را وارد کنید" value="<?php echo e(old('description', $testimonial->description)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="alt" name="alt"
                            placeholder="آلت عکس  را وارد کنید" value="<?php echo e(old('alt', $testimonial->alt)); ?>">
                        <?php $__errorArgs = ['alt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/testimonial/edit.blade.php ENDPATH**/ ?>