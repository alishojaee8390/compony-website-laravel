...
<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <div
            ...
            <div>
                <a href="<?php echo e(route('counter.create')); ?>" class="btn btn-success btn-sm p-2">ایجاد بخش شمارنده</a>
            </div>
            <div>
                ...
                <tbody>
                    <?php $__currentLoopData = $counters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $counter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="text-center"><?php echo e($counter->title); ?></td>
                            <td class="text-center"><?php echo e($counter->description); ?></td>
                            <td class="text-center"><i class="<?php echo e($counter->icon); ?>"></i></td>
                            <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                                ...
                                <form action="<?php echo e(route('counter.destroy', $counter->id)); ?>" class="mb-2" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/counter/index.blade.php ENDPATH**/ ?>