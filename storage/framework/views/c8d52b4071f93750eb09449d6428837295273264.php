...
<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <div>
            <form action="<?php echo e(route('blog.update', $blog->id)); ?>" method="post" enctype="multipart/form-data" id="form">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="subject" name="subject"
                            placeholder="عنوان بلاگ را وارد کنید" value="<?php echo e(old('subject' , $blog->subject)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($category->id); ?>" <?php if(old('category_id' , $category->id) === $blog->category_id): ?>
                                    selected
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        placeholder="آلت بلاگ را وارد کنید" value="<?php echo e(old('alt' , $blog->alt)); ?>">
                        <?php $__errorArgs = ['alt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 mt-3 p-2">
                        ...
                        <textarea name="body" id="body" cols="30" rows="30"><?php echo e(old('body' , $blog->body)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="title" name="title"
                            placeholder="عنوان صفحه را وارد کنید" value="<?php echo e(old('title' , $blog->title)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="description" name="description"
                            placeholder="درباره صفحه را وارد کنید" value="<?php echo e(old('description' , $blog->description)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="hidden" class="form-control p-1 mb-2" id="keywords" name="keywords"
                            value="<?php echo e(old('keywords', $blog->keywords)); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/blog/edit.blade.php ENDPATH**/ ?>