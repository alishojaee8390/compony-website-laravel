...
<?php $__env->startSection('title'); ?>
    <title>ایجاد بخش دسته بندی</title>
<?php $__env->stopSection(); ?>


<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        <h5 class="text-white">ایجاد دسته بندی</h5>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="name" name="name"
                            placeholder="عنوان را وارد کنید" value="<?php echo e(old('name')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/category/create.blade.php ENDPATH**/ ?>