...
<?php $__env->startSection('title'); ?>
    <title>ایجاد بخش شمارنده</title>
<?php $__env->stopSection(); ?>


<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        <h5 class="text-white">ایجاد بخش شمارنده</h5>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="description" name="description"
                            placeholder="توضیحات را وارد کنید" value="<?php echo e(old('description')); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="icon" name="icon"
                            placeholder="آیکون" value="<?php echo e(old('icon')); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/counter/create.blade.php ENDPATH**/ ?>