                ...
                <div class="row mt-3">
                        ...
                        <div class="col-12 mt-3 p-2">
                            ...
                            <input type="text" class="form-control p-1 mb-2" id="question" name="question"
                                placeholder="سوال را وارد کنید" value="<?php echo e(old('question' , $faq->question)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12 mt-3 p-2">
                            ...
                            <textarea name="answer" id="answer" cols="30" rows="10" class="form-control p-2" placeholder="جواب خود را وارد کنید"><?php echo e(old('answer' , $faq->answer)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/faq/edit.blade.php ENDPATH**/ ?>