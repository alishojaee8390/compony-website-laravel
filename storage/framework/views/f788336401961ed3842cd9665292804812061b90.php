...
<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <div
            ...
            <div>
                <a href="<?php echo e(route('footer-quick-menu.create')); ?>" class="btn btn-success btn-sm p-2">ایجاد منو</a>
            </div>
            <div>
        ...
        <section class="table-responsive mt-5">
            <table class="admin-table table table-hover">
                ...
                <tbody>
                    <?php $__currentLoopData = $footerQuickMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $footerQuickMenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        
                  
                    <tr>
                        <th scope="row" class="text-center"><?php echo e($key + 1); ?></th>
                        <td class="text-center"><?php echo e($footerQuickMenu->title); ?></td>
                        <td class="text-center"><?php echo e(Str::limit($footerQuickMenu->link, 30)); ?></td>
                        <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                            <div class="mb-2">
                                <a href="<?php echo e(route('footer-quick-menu.edit', $footerQuickMenu->id)); ?>" class="btn btn-warning text-white p-2">
                                    <i class="fa fa-edit ms-2"></i>
                                    ویرایش
                                </a>
                            </div>
                            <form action="<?php echo e(route('footer-quick-menu.destroy', $footerQuickMenu->id)); ?>" class="mb-2" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/footer/quickMenu/index.blade.php ENDPATH**/ ?>