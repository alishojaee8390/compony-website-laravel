...
<?php $__env->startSection('title'); ?>
    <title>ویرایش بخش تیم</title>
<?php $__env->stopSection(); ?>


<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        <h5 class="text-white">ویرایش بخش تیم</h5>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="fullName" name="fullName"
                            placeholder="نام و نام خانوادگی را وارد کنید" value="<?php echo e(old('fullName',$team->fullName)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="job" name="job"
                            placeholder="رتبه سازمانی را وارد کنید" value="<?php echo e(old('job' , $team->job)); ?>">
                        <?php $__errorArgs = ['job'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="alt" name="alt"
                            placeholder="آلت تصویر را وارد کنید" value="<?php echo e(old('alt', $team->alt)); ?>">
                        <?php $__errorArgs = ['alt'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_instagram" name="url_instagram"
                            placeholder="لینک اینستاگرام را وارد کنید" value="<?php echo e(old('url_instagram', $team->url_instagram)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_facebook" name="url_facebook"
                            placeholder="لینک فیسبوک را وارد کنید" value="<?php echo e(old('url_facebook', $team->url_facebook)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_tiwtter" name="url_twitter"
                            placeholder="لینک توییتر را وارد کنید" value="<?php echo e(old('url_tiwtter', $team->url_twitter)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-12 col-md-6 mt-3 p-2">
                        ...
                        <input type="text" class="form-control p-1 mb-2" id="url_linkden" name="url_linkden"
                            placeholder="لینک لینکدین را وارد کنید" value="<?php echo e(old('url_linkden', $team->url_linkden)); ?>">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/team/edit.blade.php ENDPATH**/ ?>