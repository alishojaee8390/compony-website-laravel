...
<?php $__env->startSection('main-content'); ?>
    <section class="p-3 rounded-3 bg-white-20">
        ...
        <div
            ...
            <div>
                <a href="<?php echo e(route('category.create')); ?>" class="btn btn-success btn-sm p-2">ایجاد دسته بندی</a>
            </div>
            <div>
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td class="d-flex gap-2 text-start justify-content-end w-16-rem align-items-center">
                                ...
                                <form action="<?php echo e(route('category.destroy', $category->id)); ?>" class="mb-2" method="POST">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel-project\compony\compony\resources\views/admin/category/index.blade.php ENDPATH**/ ?>